import { a as useContacts, b as downloadCsv } from "./hooks-DJqooqkf.js";
import { d as Badge, h as Button } from "./router-C_gzCGaY.js";
			...
			columns: [
				...
				},
				{
					...
					cell: ({ row }) => /* @__PURE__ */ jsx("div", {
						...
						children: row.original.discovery_profiles.length > 0 ? row.original.discovery_profiles.map((profile) => /* @__PURE__ */ jsx(Badge, {
							variant: "secondary",
							className: "text-[10px]",
							children: profile
						}, profile)) : /* @__PURE__ */ jsx("span", {
							className: "text-xs text-muted-foreground",
							children: "not discovered"
						})
					})
				},
				{

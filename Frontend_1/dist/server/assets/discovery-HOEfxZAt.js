import { d as useDiscoveryStaging, f as useDiscoveryStagingDetail, l as useDiscoveryProfiles, u as useDiscoveryRuns, v as apiPost, x as cn } from "./hooks-DJqooqkf.js";
import { d as Badge, h as Button, m as Input, p as Separator } from "./router-C_gzCGaY.js";
...
import { t as Label } from "./label-5RSmnmu2.js";
import { i as TabsTrigger, n as TabsContent, r as TabsList, t as Tabs } from "./tabs-gBXSGcsv.js";
					...
					children: latestRun ? /* @__PURE__ */ jsxs(Fragment, { children: [
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: latestRun.status === "running" ? "Live counts refresh every 2 seconds" : `Started ${new Date(latestRun.started_at).toLocaleString()}`
							}), /* @__PURE__ */ jsxs("span", {
						...
						latestRun.status === "failed" && latestRun.errors.length > 0 ? /* @__PURE__ */ jsxs("p", {
							className: "rounded-md border border-destructive/40 bg-destructive/10 px-3 py-2 text-sm text-destructive",
							children: ["Discovery failed: ", latestRun.errors[0]]
						}) : null
					] }) : /* @__PURE__ */ jsx("div", {
							...
							children: runs.data?.length === 0 ? /* @__PURE__ */ jsx("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										run.status === "failed" && run.errors.length > 0 ? /* @__PURE__ */ jsx("p", {
											className: "truncate text-xs text-destructive",
											children: run.errors[0]
										}) : null
									]

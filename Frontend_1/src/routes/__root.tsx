    ...
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This module doesn't exist in the Outreach Hub yet.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "Yash Technology Outreach Hub" },
      {
        name: "description",
        content:
          "AI-powered B2B lead discovery, CRM and outreach platform for Yash Technology sales teams.",
      },
    ...
    links: [
      ...
      { rel: "icon", href: "/yash-technology-logo.png", type: "image/png" },
    ],
  }),

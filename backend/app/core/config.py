...
class Settings(BaseSettings):
    ...
    apollo_reveal_phone_numbers: bool = Field(default=True, alias="APOLLO_REVEAL_PHONE_NUMBERS")
    apollo_phone_webhook_url: str = Field(default="", alias="APOLLO_PHONE_WEBHOOK_URL")
    apollo_phone_webhook_secret: str = Field(default="", alias="APOLLO_PHONE_WEBHOOK_SECRET")
